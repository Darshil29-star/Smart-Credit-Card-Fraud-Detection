...
@st.cache_resource
def load_assets():
    # Absolute path resolution to prevent Streamlit working-directory glitches
    base_dir = os.getcwd()
    paths_to_check = [
...
if pipeline is None:
    ...
    if raw_data is None:
        ...
        # Pre-calculate scores (removed card_id from drop list)
        ...
        with tab1:
            ...
            if not alert_queue.empty:
                ...
                if selected_id:
                    ...
                    # Calculate instantly as sliders move
